...
int main (int argc, char *argv[]) {
    ...
    Imagen Alo = lee_imagen("C:\\Users\\Usuario\\Escritorio\\UM\\1_Curso_2024-2025\\TP\\Practicas_TP\\SS\\s03_new\\alonso\\fernando2.bmp",1);
    ...
    while ( pantalla_activa() ) {
        ...
        if (colision_enemigos_objeto(enemigo, n, personaje.x, personaje.y, personaje.w, personaje.h)) {
            vidas -= 1;
            personaje.velocidad -= 1;
            personaje.x = rand() % 730;
            personaje.y = rand() % 420;
        }
